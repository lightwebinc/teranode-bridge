...
import (
	...
	"github.com/lightwebinc/teranode-bridge/announce"
...
func main() {
	var (
		txListen      = flag.String("tx-listen", "[::]:8725", "delivery lane: transactions (BRC-30 EF only; a BRC-12 standard transaction is refused at the lane)")
